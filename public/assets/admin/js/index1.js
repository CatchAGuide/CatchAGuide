$(function(e) {
    ...
    if (profitCanvas) {
        var ctx = profitCanvas.getContext('2d');
        ctx.height = 10;
        var myChart = new Chart(ctx, {
            type: 'bar',
            data: {
    ...
    /* Costchart */
    var costCanvas = document.getElementById('costchart');
    if (costCanvas) {
        var ctx = costCanvas.getContext('2d');
        ctx.height = 10;
        var myChart = new Chart(ctx, {
            type: 'line',
            data: {
    ...
    if (transactionsCanvas) {
        transactionsCanvas.height = "330";
        var myCanvasContext = transactionsCanvas.getContext("2d");
        ...
        var myChart = new Chart(transactionsCanvas, {
            type: 'line',
            data: {
