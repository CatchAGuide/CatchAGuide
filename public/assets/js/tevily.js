(function ($) {
  ...
  if ($(".new-custom-owl").length) {
    $(".new-custom-owl").owlCarousel({
      center:true,
      items: 1,
      margin: 10,
      loop:true,
  ...
  if ($(".methods-custom-owl").length) {
    $(".methods-custom-owl").owlCarousel({
      center:true,
      items: 1,
      margin: 10,
      loop:false,
