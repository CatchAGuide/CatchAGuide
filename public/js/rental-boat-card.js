// Rental Boat Card Component - Vanilla JavaScript
(function() {
    'use strict';
    ...
    function initRentalBoatCards() {
        ...
        cards.forEach(function(card) {
            ...
            // Modal elements
            const modal = card.querySelector('[data-rental-boat-modal]');
            const modalImage = modal ? modal.querySelector('.rental-boat-gallery-modal__image') : null;
            const modalClose = modal ? modal.querySelector('.rental-boat-gallery-modal__close') : null;
            const modalPrev = modal ? modal.querySelector('.rental-boat-gallery-modal__prev') : null;
            const modalNext = modal ? modal.querySelector('.rental-boat-gallery-modal__next') : null;
            const modalCurrent = modal ? modal.querySelector('.rental-boat-gallery-modal__current') : null;
            const modalTotal = modal ? modal.querySelector('.rental-boat-gallery-modal__total') : null;
