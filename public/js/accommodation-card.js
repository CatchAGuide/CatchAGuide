// Accommodation Card Component - Vanilla JavaScript
(function() {
    'use strict';
    ...
    function initAccommodationCards() {
        ...
        cards.forEach(function(card) {
            ...
            // Modal elements
            const modal = card.querySelector('[data-accommodation-modal]');
            const modalImage = modal ? modal.querySelector('.accommodation-gallery-modal__image') : null;
            const modalClose = modal ? modal.querySelector('.accommodation-gallery-modal__close') : null;
            const modalPrev = modal ? modal.querySelector('.accommodation-gallery-modal__prev') : null;
            const modalNext = modal ? modal.querySelector('.accommodation-gallery-modal__next') : null;
            const modalCurrent = modal ? modal.querySelector('.accommodation-gallery-modal__current') : null;
            const modalTotal = modal ? modal.querySelector('.accommodation-gallery-modal__total') : null;
