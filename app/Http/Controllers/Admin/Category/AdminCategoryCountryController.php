...
class AdminCategoryCountryController extends Controller
{
    ...
    public function create()
    {
        ...
        $data = compact('route', 'method', 'name', 'thumbnail', 'title', 'sub_title', 'introduction', 'body', 'place', 'placeLat', 'placeLng', 'country', 'fish_chart', 'fish_size_limit', 'fish_time_limit', 'faq');
    ...
    {
        $request->validate([
            'name' => 'required|max:255|unique:destinations',
    ...
    {
        $request->validate([
            'name' => 'required|max:255|unique:destinations,name,'.$id.',id,deleted_at,null',
            'title' => 'required|max:255',
            'sub_title' => 'required|max:255',
            'filters' => 'required'
        ]);
