...
class AdminEditGuiding extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.admin-edit-guiding',[
    ...
    {           
        ...
        return redirect()->route('admin.guidings.index')->with(['message' => 'Guiding Updated Successfully!']);
