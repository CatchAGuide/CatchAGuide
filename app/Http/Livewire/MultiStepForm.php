...
class MultiStepForm extends Component
{
    ...
    public function register()
    {
        ...
        $guiding = Guiding::create([
            ...
            'location' =>  mb_convert_encoding($this->location, 'UTF-8', 'auto'),
            'country' => mb_convert_encoding($this->country, 'UTF-8', 'auto'),
            ...
            'lng' =>  $this->lng,
            'user_id' =>  auth()->id(),
            'water_sonstiges' =>  mb_convert_encoding($this->water_sonstiges, 'UTF-8', 'auto'),
            ...
            'additional_information' =>  mb_convert_encoding($this->additional_information, 'UTF-8', 'auto'),
            'required_special_license' =>  mb_convert_encoding($this->required_special_license, 'UTF-8', 'auto'),
            ...
            'water_name' =>  mb_convert_encoding($this->water_name, 'UTF-8', 'auto'),
            'thumbnail_path' => $featured_image,
            'galleries' => json_encode($galleries),
            'needed_equipment' =>  mb_convert_encoding($this->needed_equipment, 'UTF-8', 'auto'),
            // 'equipment_status_id' =>  $this->required_equipment,
            'meeting_point' =>  mb_convert_encoding($this->meeting_point, 'UTF-8', 'auto'),
            'target_fish_sonstiges' =>   mb_convert_encoding($this->target_fish_sonstiges, 'UTF-8', 'auto'),
            'methods_sonstiges' =>  mb_convert_encoding($this->methods_sonstiges, 'UTF-8', 'auto'),
        ]);
