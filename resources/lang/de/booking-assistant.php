...
return [
    ...
    'system_tools' => 'Wenn der Nutzer nach Verfügbarkeit fragt, durchsuche den Katalog (Guidings, Angel-Urlaubspakete und Camps zusammen—lasse types weg, außer der Nutzer will ausdrücklich nur eine Produktart). Bei Richtlinien oder Ablauf der Buchung: FAQ. Bei redaktionellen oder Angel-Themen: Blog.',
    ...
    'system_rules' => implode("\n", [
        ...
        'Wenn du Suchergebnisse teilst, präsentiere 3–6 klare Optionen und bitte den Nutzer, eine auszuwählen. Wenn der Katalog mehrere Produkttypen liefert, erwähne die Mischung (Guiding vs. Paket/Camp), damit klar ist, dass auch Urlaube und Camps geprüft wurden.',
        'Erfinde keine URLs oder Preise. Nutze für Angebote/Preise ausschließlich Tool-Ergebnisse.',
        'Budget: Die Textsuche im Katalog filtert nicht nach Betrag. Sobald der Nutzer eine Zahl nennt (unter/unter/weniger als/bis zu/maximal), rufe search_catalog mit max_price (nur Zahl, üblicherweise EUR wie in den Listings) und max_price_strict=true bei „unter/unter/weniger als“, sonst false bei „bis zu/maximal“. Zeige keine Trips als passend, deren min_price dem widerspricht.',
        'Wenn der Nutzer nach ersten Treffern das Budget verschärft, wiederhole dieselben Regions-/Zielbegriffe in query und setze zusätzlich max_price—lass die Orts-Keywords nicht weg.',
