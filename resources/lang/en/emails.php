...
return [
    ...
    'contact_admin' => [
        ...
        'intro' => 'A new contact request was submitted on the website. Details are below.',
        'section_contact' => 'Contact details',
        'section_source' => 'Source & booking',
        ...
        'source_title' => 'Title',
        'view_requests' => 'View contact requests',
        'login' => 'Login',
    ],
    ...
    'contact_customer' => [
        ...
        'greeting' => 'Dear :name,',
        'intro' => 'Thank you for contacting us. We have received your request and we\'ll get back to you in the next 24h.',
        'intro_secondary' => 'Below is a summary of the details you submitted.',
    ...
    'product_report_admin' => [
        'subject' => 'New product report / notice & takedown',
        'title' => 'New product report',
        'greeting' => 'Dear Administrator,',
        'intro' => 'A notice & takedown report was submitted. Details are below.',
        'section_contact' => 'Reporter details',
        'section_report' => 'Report details',
        ...
        'view_reports' => 'View product reports',
        'login' => 'Login',
    ],
    ...
    'product_report_customer' => [
        ...
        'greeting' => 'Dear :name,',
        'intro' => 'Thank you for submitting a notice & takedown report. Our team will review it manually.',
        'intro_secondary' => 'Below is a summary of what you submitted. Listings are not removed automatically.',
        'section_report' => 'Your report',
        'section_message' => 'Your description',
        'reason' => 'Reason',
        'reported_url' => 'Reported URL',
        'listing' => 'Listing',
        'contact_us' => 'Contact us',
    ...
    'vacation_booking_admin' => [
        'subject' => 'New trip/camp booking request',
        'title' => 'New booking request',
        'greeting' => 'Hello team,',
        'intro' => 'A guest just submitted a booking request for a trip or camp. Details are below — please follow up soon.',
        'section_contact' => 'Guest details',
        'section_source' => 'Booking details',
        'section_message' => 'Guest message',
        'name' => 'Name',
        'email' => 'Email',
        'phone' => 'Phone',
        'message' => 'Message',
    ...
    'vacation_booking_customer' => [
        'subject' => 'Your fishing adventure request is in!',
        'title' => 'We\'ve got your booking request',
        'greeting' => 'Hi :name,',
        'intro' => 'Thanks for choosing Catch A Guide! We\'ve received your booking request and our team is already checking availability for you. We\'ll get back to you in the next 24h.',
        'intro_secondary' => 'Here\'s a quick summary of what you asked for — we\'ll be in touch shortly with the next steps.',
        'section_contact' => 'Your details',
        'section_request' => 'Your adventure',
        'section_message' => 'Your message',
        'name' => 'Name',
        'email' => 'Email',
        'phone' => 'Phone',
        ...
        'contact_us' => 'Contact us',
        'visit_website' => 'Explore more trips',
    ],
    ...
    'newsletter_admin' => [
        ...
        'greeting' => 'Hello team,',
        'intro' => 'Someone just subscribed to the Catch A Guide newsletter. Details are below.',
        'section_subscriber' => 'Subscriber details',
        'email' => 'Email',
        'language' => 'Language',
        'view_subscribers' => 'View newsletter list',
        'login' => 'Login',
    ],

    'newsletter_customer' => [
        'subject' => 'Thanks for joining our newsletter',
        'title' => 'Welcome to the Catch A Guide newsletter',
        'greeting' => 'Hello,',
        'intro' => 'Thanks for subscribing to the Catch A Guide newsletter! You\'re now part of our community and will receive updates on tours, fishing holidays, and special offers.',
        'intro_secondary' => 'We\'ve saved the email address below for your subscription.',
        'section_subscription' => 'Your subscription',
        'section_expect' => 'What to expect',
        'email' => 'Email',
        'benefit_tours' => 'Latest tours: Be the first to hear about new fishing trips and guidings.',
        'benefit_offers' => 'Exclusive offers: Special deals reserved for newsletter subscribers.',
        'benefit_tips' => 'Tips & tricks: Practical advice to get ready for your next adventure.',
        'closing' => 'Keep an eye on your inbox so you don\'t miss the next adventure. If you have any questions, we\'re happy to help.',
        'contact_us' => 'Contact us',
        'visit_website' => 'Visit our website',
    ],

    'guide_application_received_subject' => 'Welcome to Catch A Guide – your application is in review',
    'guide_application_received_title' => 'Your guide application is in review',
    'guide_application_received_greeting' => 'Hello :name,',
    'guide_application_received_body' => 'We received your guide application. You can already log in, complete your guide profile, and create tour drafts. Tours go live after we approve your application (usually within 24 hours).',
    'guide_application_received_next_steps' => 'What you can do now',
    'guide_application_received_step_profile' => 'Complete your guide profile (photo, bio, payment methods)',
    'guide_application_received_step_drafts' => 'Create fishing tours as drafts',
    'guide_application_received_step_review' => 'We review your application (usually within 24 hours)',
    'guide_application_received_cta_profile' => 'Complete guide profile',
    'guide_application_received_cta' => 'Go to your dashboard',

    'guide_admin_new_request_subject' => 'New guide application: :name',
    'guide_admin_new_request_title' => 'New guide application',
    'guide_admin_new_request_intro' => 'Someone has applied to become a guide on Catch A Guide. Please review the application in the admin panel.',
    'guide_admin_new_request_body' => 'A new guide application was submitted by :name (:email).',
    'guide_admin_new_request_name' => 'Name:',
    'guide_admin_new_request_type' => 'Type:',
    'guide_admin_new_request_phone' => 'Phone:',
    'guide_admin_new_request_location' => 'Address:',
    'guide_admin_new_request_cta' => 'Review in admin panel',

    'guide_application_approved_subject' => 'You are verified – your tours can go live',
    'guide_application_approved_title' => 'You are now a verified guide',
    'guide_application_approved_greeting' => 'Hello :name,',
    'guide_application_approved_body' => 'Your guide application has been approved. You can now publish your drafted tours.',
    'guide_application_approved_cta' => 'Manage my guidings',

    'guide_application_rejected_subject' => 'Update on your guide application',
    'guide_application_rejected_title' => 'Guide application not approved',
    'guide_application_rejected_greeting' => 'Hello :name,',
    'guide_application_rejected_body' => 'Thank you for your interest in becoming a guide on Catch A Guide. After reviewing your application, we are unable to approve it at this time.',
    'guide_application_rejected_reason_label' => 'Message from our team',
