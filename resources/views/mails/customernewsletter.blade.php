@php
    $copy = $copyNamespace ?? 'emails.newsletter_customer';
@endphp
<!DOCTYPE html>
            ...
            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 12px; box-shadow: 0 4px 24px rgba(0,0,0,0.08); overflow: hidden;">
                ...
                <tr>
                    <td style="padding: 0 20px 12px;">
                        <p style="margin: 0 0 8px; font-size: 11px; color: #64748b; text-transform: uppercase; letter-spacing: 0.5px; font-weight: 600;">{{ __($copy . '.section_subscription') }}</p>
                ...
                <tr>
                    <td style="padding: 0 20px 14px;">
                        <p style="margin: 0 0 8px; font-size: 11px; color: #64748b; text-transform: uppercase; letter-spacing: 0.5px; font-weight: 600;">{{ __($copy . '.section_expect') }}</p>
                            ...
                            <tr>
                                <td style="padding: 12px 14px;">
                                    <ul style="margin: 0; padding-left: 18px; font-size: 13px; color: #334155; line-height: 1.6;">
                                        <li style="margin-bottom: 6px;">{{ __($copy . '.benefit_tours') }}</li>
                                        <li style="margin-bottom: 6px;">{{ __($copy . '.benefit_offers') }}</li>
                                        <li style="margin-bottom: 0;">{{ __($copy . '.benefit_tips') }}</li>
                                    </ul>
                                </td>
                            </tr>
                        </table>
                ...
                <tr>
                    <td style="padding: 0 20px 14px;">
                        <p style="margin: 0; font-size: 12px; color: #475569; line-height: 1.5;">{{ __($copy . '.closing') }}</p>
                    </td>
                </tr>
                {{-- CTA --}}
                <tr>
