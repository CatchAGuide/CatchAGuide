        ...
        <div class="content-header" style="padding: 20px;">
            ...
            <div style="margin-top: 2rem;">
                ...
                <div style="text-align: center; margin-top: 2rem;">
                    <a style="background-color: #e8604c; padding: 10px 20px; color: #fff !important; border: 0; text-decoration: none; margin-top: 30px; font-family: 'Morrison', sans-serif; display: inline-block;" href="{{route('additional.contact')}}">Contact Us</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <tr>
                <td style="padding: 10px; text-align: left; width: 50%; vertical-align: top;">
                    ...
                    <p style="margin-top: 5px; margin-bottom: 5px;">
                        <a href="mailto:{{env('CEO_EMAIL')}}" style="color: #fff; font-size: 14px; text-decoration: none;">{{env('CEO_EMAIL')}}</a>
                    </p>
                </td>
