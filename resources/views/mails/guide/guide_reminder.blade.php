...
<head>
    ...
    <title>{{__('emails.guide_reminder_to_respond_24hrs_title')}}</title>
...
<div class="container" style="width: 100%; max-width: 600px; margin: 0 auto; background-color: white; box-shadow: 0 4px 6px 3px rgba(0, 0, 0, 0.1);">
    <div class="header" style="text-align: center; padding: 20px;">
        <a href="{{route('welcome')}}" target="_blank">
         ...
         <h2 class="header-title" style="font-family: 'Morrison', sans-serif;">{{__('emails.guide_reminder_to_respond_24hrs_title')}}</h2>
    </div>
    <div class="content" style="padding-bottom: 0px;">
        <div class="content-header" style="padding: 20px;">
            <p style="font-size: 16px; font-family: 'Morrison', sans-serif;">@lang('emails.dear') <strong>{{$guide->firstname}}</strong>,</p>
            <p style="font-size: 14px; font-family: 'Morrison', sans-serif;">@lang('emails.guide_reminder_to_respond_24hrs_text_1')</p>
                    ...
                    <ul style="padding-left: 18px; margin-top: 0;">
                        ...
                        @if(is_array($extras) && count($extras))
                            @foreach($extras as $extra)
                                <li style="font-size: 14px; font-family: 'Morrison', sans-serif;">
                                    {{ $extra['extra_name'] ?? '' }}@if(!empty($extra['extra_quantity'])): ({{ $extra['extra_quantity'] }})@endif
                                </li>
                            @endforeach
                        @else
                            <li style="font-size: 14px; font-family: 'Morrison', sans-serif;">@lang('emails.no_extras')</li>
                        @endif
                    </ul>
                    <p style="font-size: 14px; font-family: 'Morrison', sans-serif;">
            ...
            <div style="margin-top: 2rem;">
                <p style="font-size: 14px; font-family: 'Morrison', sans-serif;">@lang('emails.guide_reminder_to_respond_24hrs_text_2')</p>

                <div style="text-align: center; margin-top: 2rem;">
                    {{-- Accept / Reject actions (same as request email) --}}
                    @if($booking->status === 'pending')
                        <a class="btn-theme" style="background-color: #e8604c; padding: 10px 20px; color: #fff !important; border: 0; text-decoration: none; margin-top: 30px; font-family: 'Morrison', sans-serif; display: inline-block; margin-right: 10px;" href="{{ route('booking.accept', [$booking->token]) }}">
                            @lang('emails.accept')
                        </a>
                        <a class="btn-theme" style="background-color: #fff; padding: 10px 20px; color: #e8604c !important; border: 1px solid #e8604c; text-decoration: none; margin-top: 30px; font-family: 'Morrison', sans-serif; display: inline-block;" href="{{ route('booking.reject', [$booking->token]) }}">
                            @lang('emails.reject')
                        </a>
                    @endif
                    ...
                    <div style="margin-top: 1.5rem;">
                        <a style="background-color: #e8604c; padding: 10px 20px; color: #fff !important; border: 0; text-decoration: none; margin-top: 10px; font-family: 'Morrison', sans-serif; display: inline-block; margin-right: 10px;" href="{{route('profile.bookings', ['id' => $booking->id])}}">
                            @lang('emails.view_bookings')
                        </a>
                        <a style="background-color: #313041; padding: 10px 20px; color: #fff !important; border: 0; text-decoration: none; margin-top: 10px; font-family: 'Morrison', sans-serif; display: inline-block;" href="{{route('additional.contact')}}">
    ...
    <div style="margin-top: 2rem; padding: 0 20px;">
        <p style="font-size: 14px; font-family: 'Morrison', sans-serif;">
            @lang('emails.guide_reminder_to_respond_24hrs_text_3')
        </p>
        <p style="margin-top: 2rem; margin-bottom: .5rem; font-size: 14px; font-family: 'Morrison', sans-serif;">
            @lang('emails.best_regards')
        </p>
        <p style="margin-top: .5rem; font-size: 14px; font-family: 'Morrison', sans-serif;">
            @lang('emails.catchaguide_team')
        </p>
    </div>


    <div class="footer" style="text-align: center; padding: 20px; color: #fff; background-color: #313041; margin-top: 2rem; font-family: 'Morrison', sans-serif;">
        <table width="100%" cellpadding="0" cellspacing="0" border="0">
            <tr>
                <td style="padding: 10px; text-align: left; width: 50%; vertical-align: top;">
                    <img class="logo" src="https://catchaguide.com/assets/images/logo/CatchAGuide2_Logo_PNG.png" width="100px" alt="Catchaguide Logo" style="display: block;">
                ...
                <td style="padding: 10px; vertical-align: top;">
                    <a style="color: #fff; text-decoration: none;" href="{{route('additional.contact')}}" target="_blank">
                        <p style="margin-top: 0; margin-bottom: 10px; font-size: 14px;">Contact us</p></a>
                    <p style="margin: .5rem 0; font-size: 14px;">Follow us</p>
                    <div class="social-icons" style="margin-top: 10px;">
                        <a href="https://www.facebook.com/CatchAGuide" target="_blank" style="display: inline-block;">
                        ...
                        <a style="padding-left: .5rem; display: inline-block;" href="https://wa.me/+4915155495574" target="_blank">
                        ...
                        <a style="padding-left: .5rem; display: inline-block;" href="https://www.instagram.com/catchaguide_official/" target="_blank">
        ...
        <div style="text-align: center;">
            <p style="font-size: 14px; margin: 10px 0;">© Catchaguide {{date('Y')}}</p>
        </div>       
    </div>
</div>
