...
<div class="container" style=" width: 100%;max-width: 600px;margin: 0 auto;background-color: white;box-shadow: 0 4px 6px 3px rgba(0, 0, 0, 0.1);">
    <div class="header" style="text-align: center;padding: 20px;">
        ...
        <h2 class="header-title">Buchungsanfrage abgelaufen – Keine Antwort erhalten</h2>
    </div>
    <div class="content" style="padding-bottom:0px;">
        <div class="content-header" style="padding: 20px;">
            <p style="font-size:16px;">Lieber <strong>Guide Name</strong>,</p>
            <p>Wir möchten Dich darüber informieren, dass die kürzliche Buchungsanfrage für eine Angeltour aufgrund einer fehlenden Antwort von Dir innerhalb des 72-Stunden-Zeitrahmens abgelaufen ist.</p>
            <p>Zur Erinnerung: Alle Buchungsanfragen auf unserer Plattform laufen nach 72 Stunden ab, wenn keine Antwort erfolgt, damit Gäste ihre Reisen ohne unnötige Verzögerungen weiter planen können. Wir empfehlen, auf neue Anfragen so schnell wie möglich zu antworten, um keine zukünftigen Möglichkeiten zu verpassen.</p>

            <div style="margin-top:20px;">
                <p>Wenn Du Unterstützung benötigst oder Fragen hast, zögere nicht, uns jederzeit zu kontaktieren. Wir sind hier, um Dich zu unterstützen.</p>
            </div>
