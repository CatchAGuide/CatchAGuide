...
<div class="container" style=" width: 100%;max-width: 600px;margin: 0 auto;background-color: white;box-shadow: 0 4px 6px 3px rgba(0, 0, 0, 0.1);">
    <div class="header" style="text-align: center;padding: 20px;">
        ...
        <h2 class="header-title">Neue Buchungsanfrage für Deine Angeltour</h2>
    </div>
    <div class="content" style="padding-bottom:0px;">
        <div class="content-header" style="padding: 20px;">
            <p style="font-size:16px;">Lieber <strong>Guide Name</strong>,</p>
            <p>
                Du hast eine neue Buchungsanfrage auf unserer Plattform erhalten. Hier sind die Details der Anfrage:
            </p>
        </div>
    </div>
    <div class="order-details">
        <div class="booking-details">
            <p><strong>Gast: </strong> [Guest Name]</p>
            <p><strong>Tour: </strong><a href="https://example.com/guidings/1/slug" style="text-decoration: none;font-weight:bold">Tour Title</a></p>
            <p><strong>Ort: </strong> Location Name</p>
            <p><strong>Datum: </strong> March 20, 2025</p>
    ...
    <div class="" style="padding: 20px;">
        ...
        <p style="margin-bottom: 2rem;">Bitte überprüfe die Anfrage und teile uns Deine Entscheidung mit. Du kannst die Buchung entweder annehmen oder ablehnen, indem Du auf die untenstehenden Schaltflächen klickst:</p>
            <a class="btn-theme" style="background-color: #e8604c;padding:10px 20px;color:#fff !important;border:0;text-decoration: none;margin-top:30px;" href="https://example.com/booking/accept/token">Anfrage annehmen</a>
            <a class="btn-theme" style="background-color: #e8604c;padding:10px 20px;color:#fff !important;border:0;text-decoration: none;margin-top:30px;" href="https://example.com/booking/reject/token">Anfrage ablehnen</a>
        </div>
        ...
        <div style="margin-top:3rem;">
            <p>
                Danke, dass Du Teil unserer Plattform bist. Wir freuen uns auf Deine Antwort.
            </p>
