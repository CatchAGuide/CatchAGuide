<div style="width: 100%; max-width: 600px; margin: 0 auto; background-color: white; box-shadow: 0 4px 6px 3px rgba(0, 0, 0, 0.1); font-family: Arial, sans-serif;">
    <div style="text-align: center; padding: 20px;">
        ...
        <h2 style="margin: 0;">
            {{ __('emails.rating_confirmation_subject') }}
        </h2>
    </div>
    <div style="padding-bottom:0px;">
        <div style="padding: 20px;">
            ...
            <div style="margin: 2rem 0; padding: 20px; border: 1px solid #e1e1e1; border-radius: 8px; background-color: #f9f9f9;">
                <div style="text-align: center; margin-bottom: 20px;">
                    <h3 style="color: #313041; margin-bottom: 10px;">{{ __('emails.rating_confirmation_overall_rating') }}</h3>
                    <div style="font-size: 36px; color: #e8604c; font-weight: bold;">
                        {{ $score }}/10
                    </div>
                </div>
                ...
                <div style="border-top: 1px solid #e1e1e1; padding-top: 20px;">
                    ...
                    <p style="font-style: italic; color: #555; background: white; padding: 15px; border-radius: 6px; margin: 0;">
                        "{{ $comment }}"
                    </p>
                </div>
                @endif
