...
<div class="container" style=" width: 100%;max-width: 600px;margin: 0 auto;background-color: white;box-shadow: 0 4px 6px 3px rgba(0, 0, 0, 0.1);">
    <div class="header" style="text-align: center;padding: 20px;">
        ...
        <h2 class="header-title">Buchungsbestätigung – Gästedetails für Deine Angeltour</h2>
    </div>
    <div class="content" style="padding-bottom:0px;">
        <div class="content-header" style="padding: 20px;">
            <p style="font-size:16px; margin-top: 0;">Lieber Guide,</p>
            <p>Du hast eine neue Buchungsanfrage erfolgreich angenommen. Hier findest Du alle Details der Tour und des Gastes, der bei Dir gebucht hat. Bitte beachte, dass der Gast noch nicht bezahlt hat. Es ist wichtig, dass Du Dich so schnell wie möglich mit ihm in Verbindung setzt, um die Tour und die Zahlung abzuschließen.</p>
        </div>
    </div>
    <div class="order-details">
        <h4>Zusammenfassung der Buchung:</h4>
        <div class="booking-details">
            <p><strong>Gast Name : </strong>John</p>
            <p><strong>Gast Telefon : </strong>123-456-7890</p>
            <p><strong>Gast Email : </strong>john.doe@example.com</p>
        ...
        <p>Bitte beachte, dass wir Dir die Vermittlungsgebühr für die vereinbarte Tour am Tag der Durchführung der Angeltour in Rechnung stellen.
        </p>
        <div style="padding:0 20px;">
            <p>Wenn Du Fragen hast oder Unterstützung benötigst, zögere nicht, uns zu kontaktieren. Wir sind hier, um zu helfen!</p>
        </div>
    ...
    <div style="padding: 0 20px;">
        <p>
            Danke, dass Du unsere Plattform nutzt, und wir wünschen Dir eine erfolgreiche und angenehme Tour mit Deinem Gast!
        </p>
