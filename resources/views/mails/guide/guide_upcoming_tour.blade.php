    ...
    <div style="padding-bottom: 0px;">
        <div style="padding: 20px;">
            ...
            <div style="text-align: center; margin-top: 2rem;">
                <a style="background-color: #e8604c; padding: 10px 20px; color: #fff !important; border: 0; text-decoration: none; margin-top: 30px; font-family: 'Arial', sans-serif; display: inline-block;" href="{{route('additional.contact')}}" target="_blank">@lang('emails.contact_us')</a>
            </div>
        </div>
    </div>
        ...
        <table width="100%">
            <tr>
                <td style="padding: 10px; text-align: left; width: 50%;">
                    ...
                    <p>
                        <a href="tel:+49 (0) {{config('cag.contact_num')}}" style="color: #fff; font-size: 14px; font-family: 'Arial', sans-serif; text-decoration: none;">+49 (0) {{config('cag.contact_num')}}</a>
                    </p>
                    <p>
                        <a href="mailto:{{config('mail.admin_email')}}" style="color: #fff; font-size: 14px; font-family: 'Arial', sans-serif; text-decoration: none;">{{config('mail.admin_email')}}</a>
                    </p>
                </td>
                <td style="padding: 10px;">
                    ...
                    <p style="margin: .5rem 0; font-size: 14px; font-family: 'Arial', sans-serif;">@lang('emails.follow_us')</p>
                    <div>
