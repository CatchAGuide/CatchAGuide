...
<div class="container" style=" width: 100%;max-width: 600px;margin: 0 auto;background-color: white;box-shadow: 0 4px 6px 3px rgba(0, 0, 0, 0.1);">
    <div class="header" style="text-align: center;padding: 20px;">
        ...
        <h2 class="header-title">Deine Angeltour mit [Guest Name] in 3 Tagen!</h2>
    </div>
    <div class="content" style="padding-bottom:0px;">
        <div class="content-header" style="padding: 20px;">
            <p style="font-size:16px;">Hallo <strong>Guide Name</strong>,</p>
            <p>Dies ist eine Erinnerung, dass Du eine Angeltour mit [Guest Name] am [Location] für den [Date] um [Time] geplant hast. Bitte stelle sicher, dass Du vollständig auf die Tour vorbereitet bist und das notwendige Equipment und Material bereit hast.</p>
            <ul>
                <li>
                    <p> Überprüfe die Gästedetails: Bitte überprüfe die Tourdetails und die Gästeinformationen in Deinem Guide Dashboard.</p>
                </li>
                <li>
                    <p>Bereite das Equipment vor: Stelle sicher, dass alles in einwandfreiem Zustand ist.</p>
                </li>
                <li>
                    <p>Überprüfe Wetter- und Wasserbedingungen: Bleibe auf dem Laufenden bezüglich Wetter- und Wasserbedingungen am [Location].</p>
                </li>
            </ul>
            <p>Wir wünschen Dir und [Guest Name] eine erfolgreiche und angenehme Angeltour.</p>

            <div style="margin-top:20px;">
                <p>Wenn Du Fragen hast oder Unterstützung benötigst, kontaktiere uns bitte:</p>
            </div>
    ...
    <div style="padding: 0 20px;">
        <p>
            Danke, dass Du ein geschätzter Guide bei Catch a Guide bist.
        </p>
