...
<div class="container" style=" width: 100%;max-width: 600px;margin: 0 auto;background-color: white;box-shadow: 0 4px 6px 3px rgba(0, 0, 0, 0.1);">
    <div class="header" style="text-align: center;padding: 20px;">
        ...
        <h2 class="header-title">
            New Review for Your Fishing Tour Available!
        </h2>
    </div>
    <div class="content" style="padding-bottom:0px;">
        <div class="content-header" style="padding: 20px;">
            <p style="font-size:16px;">Hi <strong>[Guide Name]</strong>,</p>
            <p>
                We wanted to let you know that your guest recently left a review for your fishing tour on our platform. We understand how valuable feedback is, and we're excited to share the review with you.
            </p>
            <div style="margin: 2rem 0; padding: 20px; border: 1px solid #e1e1e1; border-radius: 8px; background-color: #f9f9f9;text-align: center;">
                <h3 style="margin: 0;">Overall Rating</h3>
                <p style="font-weight: bold;font-size: 24px;">8 <span style="font-weight: 500;font-size: 18px;">/ 10</span></p>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Vero, quis cumque voluptatum praesentium necessitatibus corrupti odio commodi fugiat quae. Id soluta facilis vitae impedit. Necessitatibus eos quo recusandae fugiat voluptatum.</p>
            </div>
            <div style="margin: 1.5rem 0;text-align: center;">
                <p style="text-align: center;margin-bottom: 2rem;">You can find more details about your latest review by clicking the link below:</p>
                <a  class="btn-theme" style="background-color: #e8604c;padding:10px 20px;color:#fff !important;border:0;text-decoration: none;margin-top:30px;text-align: center;" href="https://catchaguide.com/">Review</a>
            </div>
