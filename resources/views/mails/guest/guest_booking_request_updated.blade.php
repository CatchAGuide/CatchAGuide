...
<div class="container" style=" width: 100%;max-width: 600px;margin: 0 auto;background-color: white;box-shadow: 0 4px 6px 3px rgba(0, 0, 0, 0.1);">
    <div class="header" style="text-align: center;padding: 20px;">
        ...
        @lang('messages.guest_booking_request_title')
        </h2>
    </div>
    <div class="content">
        <div class="content-header" style="padding: 20px;">
            ...
            <p>
            @lang('messages.guest_booking_request_text_1')
            </p>
            <p> @lang('messages.guest_booking_request_text_2')
            </p>
        </div>
    </div>
    <div class="order-details" style="margin: 0 20px 20px 20px;">
        <div>
            <p> @lang('messages.guest_booking_request_text_3')</p>
        </div>
        <!-- <div style="margin-top:30px;">
            <a class="btn-theme" style="background-color: #e8604c;padding:10px 20px;color:#fff !important;border:0;text-decoration: none;margin-top:30px;" href="https://catchaguide.com/guiding-link">
                View guiding
            </a>
        </div> -->
        <div class="booking-details">
            ...
            <p><strong>Datum:</strong> March 15, 2025</p>
    ...
    <div class="content" style="margin: 0 20px 20px 20px;">
        <p>@lang('messages.guest_booking_request_text_4')</p>
    </div>
    <div style="text-align: center; margin-top: 2rem; padding: 0 20px;">
        <p style="margin-bottom: 2rem;"> @lang('messages.guest_booking_request_text_5')</p>
    ...
    <div style="margin-top:3rem; padding: 0 20px;">
        <p>
        @lang('messages.guest_booking_request_text_6')
        </p>
        <p style="margin-top: 2rem; margin-bottom: .5rem;">
        @lang('messages.guest_booking_request_text_7')
        </p>
        <p style="margin-top: .5rem;"> @lang('messages.guest_booking_request_text_8')</p>
    </div>
