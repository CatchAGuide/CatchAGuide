...
<head>
    ...
    <title>@lang('emails.guest_booking_request_expired_title')</title>
...
<div class="container" style="width: 100%; max-width: 600px; margin: 0 auto; background-color: white; box-shadow: 0 4px 6px 3px rgba(0, 0, 0, 0.1);">
    <div class="header" style="text-align: center; padding: 20px;">
        ...
        <h2 class="header-title">@lang('emails.guest_booking_request_expired_title')</h2>
    </div>
        ...
        <div class="content-header" style="padding: 20px;">
            ...
            <div style="margin-top:20px;">
                ...
                <div style="text-align:center; margin-top: 2rem;">
                    <a class="btn-theme" style="background-color: #e8604c;padding:10px 20px;color:#fff !important;border:0;text-decoration: none;margin-top:30px;" href="{{route('additional.contact')}}">Contact Us</a>
                </div>
            </div>
            <div style="margin-top:20px;">
                <p>
                ...
                <div style="text-align:center; margin-top: 2rem;">
                    <a class="btn-theme" style="background-color: #e8604c;padding:10px 20px;color:#fff !important;border:0;text-decoration: none;margin-top:30px;" href="{{route('guidings.index')}}">Find other fishing tours</a>
                </div>
            </div>
        </div>
        <div style="padding: 0 20px;">
            <p>
            @lang('emails.guest_booking_request_expired_text_5')
            </p>
            <p style="margin-top: 2rem; margin-bottom: .5rem;">
            @lang('emails.best_regards')
            </p>
            <p style="margin-top: .5rem;">@lang('emails.catchaguide_team')</p>
        </div>
    </div>
