...
<div class="container" style=" width: 100%;max-width: 600px;margin: 0 auto;background-color: white;box-shadow: 0 4px 6px 3px rgba(0, 0, 0, 0.1);">
    ...
    <div class="content" style="padding-bottom:0px;">
        <div class="content-header" style="padding: 20px;">
            <p style="font-size:16px;">Hallo [Guest Name],</p>
            <p>
            @lang('messages.guest_booking_request_cancelled_text_1')
            </p>
            <p><strong>
            @lang('messages.guest_booking_request_cancelled_text_2')
            </strong>
            </p>
            <p>@lang('messages.guest_booking_request_cancelled_text_3')</p>
            <p>@lang('messages.guest_booking_request_cancelled_text_4')</p>
            <ul>
                <li><p>[Alternative Date 1] at [Time]</p></li>
                <li><p>[Alternative Date 2] at [Time]</p></li>
                <li><p>[Alternative Date 3] at [Time]</p></li>
            </ul>
            <p> @lang('messages.guest_booking_request_cancelled_text_5')</p>
        </div>
