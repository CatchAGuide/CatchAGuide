...
<div class="container" style=" width: 100%;max-width: 600px;margin: 0 auto;background-color: white;box-shadow: 0 4px 6px 3px rgba(0, 0, 0, 0.1);">
    <div class="header" style="text-align: center;padding: 20px;">
        ...
        <h2>
            @lang('messages.user_account_activate_title')
        </h2>
    </div>
    ...
    <div class="content" style="padding: 0 20px 20px 20px;">
        ...
        <p>@lang('messages.user_account_activate_text_1')</p>
        <ul>
            <li>@lang('messages.user_account_activate_text_2')</li>
            <li>@lang('messages.user_account_activate_text_3')</li>
            <li>@lang('messages.user_account_activate_text_4')</li>
        </ul>

        <div class="credentials-box">
                <strong>@lang('messages.user_account_activate_text_5')</strong>
                <p><strong>@lang('messages.user_account_activate_text_6')</strong> user@example.com</p>
                <p><strong>@lang('messages.user_account_activate_text_7')</strong> tempPassword123</p>
        </div>
            <strong>@lang('messages.user_account_activate_text_8')</strong>
            <p>@lang('messages.user_account_activate_text_9')</p>
            <p>@lang('messages.user_account_activate_text_10')</p>
        <div style="text-align:center; margin: 2rem 0;">
            <a class="btn-theme" style="background-color: #e8604c;padding:10px 20px;color:#fff !important;border:0;text-decoration: none;margin-top:30px;" href="{{ route('login') }}">
                Activate Account
            </a>
        </div>
        <p>@lang('messages.user_account_activate_text_11')
        </p>
        
    </div>
    <div style="padding: 0 20px;">
        <p>
        @lang('messages.user_account_activate_text_12')
        </p>
        <p style="margin-top: 2rem; margin-bottom: .5rem;">
        @lang('messages.user_account_activate_text_13')
        </p>
        <p style="margin-top: .5rem;">@lang('messages.user_account_activate_text_14')</p>
    </div>
