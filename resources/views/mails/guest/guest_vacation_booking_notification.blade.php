...
<div style="width: 100%; max-width: 600px; margin: 0 auto; background-color: white; box-shadow: 0 4px 6px 3px rgba(0, 0, 0, 0.1);">
    <div style="text-align: center; padding: 20px;">
        ...
        <h2>
        @lang('emails.guest_vacation_booking_notification_title')
        </h2>
    </div>
    <div>
        <div style="padding: 20px;">
            <p style="font-size:14px;">{{__('emails.dear')}} {{$booking->name}},</p>
            <p style="font-size:14px;"> {{ __('emails.guest_vacation_booking_notification_text_2')}}
            </p>
        </div>
    </div>
    <div style="border:1px solid rgb(132, 132, 132); padding:10px; border-radius: 12px; margin: 0 20px 20px 20px;">
        ...
        <div>
            ...
            @endif --}}
            <p style="font-size:14px;"><strong>{{__('emails.price')}}:</strong> {{$booking->total_price}} €</p>
        </div>
    </div>
    ...
    <div style="margin-top:3rem; padding: 0 20px;">
        ...
        @lang('emails.guest_vacation_booking_notification_text_6')
        </p>
        ...
        <table width="100%">
            <tr>
                ...
                <td style="padding: 10px;">
                    ...
                    <p style="margin: .5rem 0; text-decoration: none;">@lang('emails.follow_us')</p>
                    <div>
