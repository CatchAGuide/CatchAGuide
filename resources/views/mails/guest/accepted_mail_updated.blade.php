...
<div class="container" style=" width: 100%;max-width: 600px;margin: 0 auto;background-color: white;box-shadow: 0 4px 6px 3px rgba(0, 0, 0, 0.1);">
    <div class="header" style="text-align: center;padding: 20px;">
        ...
        <h2 class="header-title">
            @lang('messages.guest_booking_request_accepted_title')
        </h2>
    </div>
    <div class="content" style="padding-bottom:0px;">
        <div class="content-header" style="padding: 20px;">
            <p style="font-size:16px;">Dear <strong>[Guest name]</strong>,</p>
            <p style="font-size:16px;">Lieber <strong>[Guest name]</strong>,</p>
            <p>
                @lang('messages.guest_booking_request_accepted_text_1') 
            </p>
            <p>
                @lang('messages.guest_booking_request_accepted_text_2') 
            </p>
            <div class="order-details">
                <h4>@lang('messages.guest_booking_request_accepted_text_3')</h4>
                <div style="margin-top:10px;">
                    <p><strong>Guide Name:</strong> [Guide Name]</p>
                    <p><strong>Guide Name:</strong> [Guide Name]</p>
                    <p><strong>Guide Phone:</strong> [Guide Phone]</p>
                    <p><strong>Guide Telefon:</strong> [Guide Phone]</p>
            ...
            <div style="margin-top:20px;">
                <p>
                    @lang('messages.guest_booking_request_accepted_text_4') 
                </p>
        ...
        <div style="padding: 0 20px;">
            <p>
                @lang('messages.guest_booking_request_accepted_text_5') 
            </p>
            <p style="margin-top: 2rem; margin-bottom: .5rem;">
                @lang('messages.guest_booking_request_accepted_text_6') 
            </p>
            <p style="margin-top: .5rem;">@lang('messages.guest_booking_request_accepted_text_7')</p>
        </div>
    </div>
