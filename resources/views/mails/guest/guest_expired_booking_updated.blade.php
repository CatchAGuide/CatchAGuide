...
<div class="container" style=" width: 100%;max-width: 600px;margin: 0 auto;background-color: white;box-shadow: 0 4px 6px 3px rgba(0, 0, 0, 0.1);">
    <div class="header" style="text-align: center;padding: 20px;">
        ...
        <h2 class="header-title">@lang('messages.guest_booking_request_expired_title')</h2>
    </div>
    <div class="content" style="padding-bottom:0px;">
        <div class="content-header" style="padding: 20px;">
            <p style="font-size:16px;">Lieber [Guest name],</p>
            <p>@lang('messages.guest_booking_request_expired_text_1')</p>
            <p>@lang('messages.guest_booking_request_expired_text_2')</p>
            <div style="margin-top:20px;">
                <p>
                @lang('messages.guest_booking_request_expired_text_3')
                </p>
            ...
            <div style="margin-top:20px;">
                <p>
                @lang('messages.guest_booking_request_expired_text_4')
                </p>
                <div style="text-align:center; margin-top: 2rem;">
                    <a class="btn-theme" style="background-color: #e8604c;padding:10px 20px;color:#fff !important;border:0;text-decoration: none;margin-top:30px;" href="https://catchaguide.com/contact">Find other fishing tours</a>
                </div>
            </div>
        </div>
        <div style="padding: 0 20px;">
            <p>
            @lang('messages.guest_booking_request_expired_text_5')
            </p>
            <p style="margin-top: 2rem; margin-bottom: .5rem;">
            @lang('messages.guest_booking_request_expired_text_6')
            </p>
            <p style="margin-top: .5rem;">@lang('messages.guest_booking_request_expired_text_7')</p>
        </div>
    </div>
