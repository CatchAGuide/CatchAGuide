...
<div class="container" style=" width: 100%;max-width: 600px;margin: 0 auto;background-color: white;box-shadow: 0 4px 6px 3px rgba(0, 0, 0, 0.1);">
    <div class="header" style="text-align: center;padding: 20px;">
        ...
        <h2 class="header-title">@lang('messages.guest_booking_request_cancelled_title')</h2>
    </div>
    <div class="content" style="padding-bottom:0px;">
        <div class="content-header" style="padding: 20px;">
            <p style="font-size:16px;">Hi [Guest Name],</p>
            <p>@lang('messages.guest_booking_request_cancelled_text_1')</p>
            <div style="margin-top: 2rem;">
                <p>@lang('messages.guest_booking_request_cancelled_text_2')</p>
                <p>@lang('messages.guest_booking_request_cancelled_text_3')</p>
            </div>
            <div style="margin-top: 2rem;">
                <p>@lang('messages.guest_booking_request_cancelled_text_4')</p>
                <ul>
                    <li>
                        <p>[Alternative Date 1] at [Time]</p>
                    </li>
                    <li>
                        <p>[Alternative Date 2] at [Time]</p>
                    </li>
                    <li>
                        <p>[Alternative Date 3] at [Time]</p>
                    </li>
                </ul>
                <p>
                @lang('messages.guest_booking_request_cancelled_text_5')
                </p>
            </div>
            <div style="margin-top:20px; text-align: center;">
                <p>@lang('messages.guest_booking_request_cancelled_text_6')</p>
            ...
            <div style="margin-top:3rem;">
                <p>
                @lang('messages.guest_booking_request_cancelled_text_7')
                </p>
                <p style="margin-top: 2rem; margin-bottom: .5rem;">
                @lang('messages.guest_booking_request_cancelled_text_8')
                </p>
                <p style="margin-top: .5rem;">@lang('messages.guest_booking_request_cancelled_text_9')</p>
            </div>
        </div>
    </div>
