...
<div style="width: 100%; max-width: 600px; margin: 0 auto; background-color: white; box-shadow: 0 4px 6px 3px rgba(0, 0, 0, 0.1);">
    <div style="text-align: center; padding: 20px;">
        ...
        <h2 style="font-family: Arial, Helvetica, sans-serif;">
            @lang('emails.guest_tour_reminder_title')
        </h2>
    </div>
    <div style="padding-bottom: 0px;">
        <div style="padding: 20px;">
            <p style="font-size: 14px;">@lang('emails.dear') {{$guestName}},</p>
            <p style="font-size: 14px;">
                {!!str_replace(['[Date]','[Location]', '[Guide Name]'], [$date, $location, $guideName], __('emails.guest_tour_reminder_text_1'))!!}
            </p>
            <ul>
                <li>
                    <p style="font-size: 14px;">{!!str_replace('[Location]', $location, __('emails.guest_tour_reminder_text_2'))!!}</p>
                </li>
                <li>
            ...
            <div style="text-align: center; margin-top: 2rem;">
                ...
                <a style="background-color: #e8604c; padding: 10px 20px; color: #fff; border: 0; text-decoration: none; margin-top: 30px; display: inline-block; font-size: 14px;" href="{{route('additional.contact')}}" target="_blank">@lang('emails.contact_us')</a>
            </div>
            <div style="margin-top: 3rem;">
                <p style="font-size: 14px;">
                    {!!__('emails.guest_tour_reminder_text_7')!!}
                </p>
                <p style="margin-top: 2rem; margin-bottom: .5rem; font-size: 14px;">
                    {!!__('emails.best_regards')!!}
                </p>
                <p style="margin-top: .5rem; font-size: 14px;">{!!__('emails.catchaguide_team')!!}</p>
            </div>
        </div>
    </div>
        ...
        <table width="100%" cellpadding="0" cellspacing="0" border="0">
            <tr>
                <td style="padding: 10px; text-align: left; width: 50%;">
                    <img src="https://catchaguide.com/assets/images/logo/CatchAGuide2_Logo_PNG.png" width="100px" alt="Catchaguide Logo" style="display: block;">
                    <p style="margin: 10px 0;">
                        <a href="tel:+49 (0) {{config('cag.contact_num')}}" style="color: #fff; font-size: 14px; text-decoration: none; text-decoration: none;">+49 (0) {{config('cag.contact_num')}}</a>
                    </p>
                    <p style="margin: 10px 0;">
                        <a href="mailto:{{config('mail.admin_email')}}" style="color: #fff; font-size: 14px; text-decoration: none; text-decoration: none;">{{config('mail.admin_email')}}</a>
                    </p>
                </td>
                <td style="padding: 10px; text-align: center;">
                    <a style="color: #fff; text-decoration: none; font-size: 14px;" href="{{route('additional.contact')}}" target="_blank">
                        <p style="margin: 10px 0;">@lang('emails.contact_us')</p>
                    </a>
