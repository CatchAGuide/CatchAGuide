...
<head>
    ...
    <title>Guest Tour Reminder</title>
...
<div class="container" style=" width: 100%;max-width: 600px;margin: 0 auto;background-color: white;box-shadow: 0 4px 6px 3px rgba(0, 0, 0, 0.1);">
    <div class="header" style="text-align: center;padding: 20px;">
        ...
        <h2 class="header-title">
            Dein Angelausflug mit Catch a Guide ist in 3 Tagen!
        </h2>
    </div>
    <div class="content" style="padding-bottom:0px;">
        <div class="content-header" style="padding: 20px;">
            <p style="font-size:16px;">Hallo <strong>[Guest Name]</strong>,</p>
            <p>
                Dies ist eine freundliche Erinnerung, dass Deine Angeltour mit [Guide Name] am [Location] für den [Date] um [Time] geplant ist! Wir sind sicher, dass Du dich auf das Wasser freust. Um sicherzustellen, dass Du bestens vorbereitet bist, hier einige Dinge, die Du beachten solltest:
            </p>
            <ul>
                <li>
                    <p><strong>Überprüfe das Wetter:</strong> Sieh Dir die Wettervorhersage für [Location] an und kleide Dich entsprechend.</p>
                </li>
                <li>
                    <p><strong>Bring Essentials mit:</strong> Vergiss nicht notwendige Angellizenzen, Sonnencreme, Hüte, Sonnenbrillen und persönliche Dinge.</p>
                </li>
                <li>
                    <p><strong>Überprüfe die Tourdetails:</strong> Überprüfe die Tourdetails in Deiner Buchungsbestätigung, um sicherzustellen, dass Du alle notwendigen Informationen hast.</p>
                </li>
            </ul>
            <p>
                Wir sind sicher, dass Du eine unvergessliche Erfahrung mit [Guide Name] haben wirst.
            </p>
            <div style="text-align:center;margin-top: 2rem;">
                <p>Wenn Du Fragen hast oder weitere Unterstützung benötigst, zögere nicht, uns zu kontaktieren:</p>
                <a class="btn-theme" style="background-color: #e8604c;padding:10px 20px;color:#fff !important;border:0;text-decoration: none;margin-top:30px;" href="https://catchaguide.com/">Contact us</a>
            </div>
            <div style="margin-top:3rem;">
                <p>
                    Wir wünschen Dir eine fantastische Angeltour!
                </p>
