                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                            ...
                            <tr>
                                <td style="padding: 20px 0 30px 0; color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 20px;">
                                    @lang('mailing.hello'){{$guide->firstname}}, <br>
                                    @lang('mailing.unfor'), <br>
                                    @lang('mailing.custData'): <br>
                                    Name: {{$user->firstname}} {{$user->lastname}} <br>
                                    @lang('mailing.pNumber'): {{$user->phone}} <br>
                                    Email: {{$user->email}} <br>
                                    @lang('mailing.bookingInfo'): <br>
                                    {{ $guiding->title ?  translate($guiding->title) : $guiding->title }} <br>
