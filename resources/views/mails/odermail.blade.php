                        ...
                        <table class="ms-content" width="640" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:collapse;width:640px;margin-top:0;margin-bottom:0;margin-right:auto;margin-left:auto;padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;background-color:#FFFFFF;border-radius:6px;box-shadow:0 3px 6px 0 rgba(0,0,0,.05);">
                            <tr>
                                <td class="ms-content-body" style="word-break:break-word;font-family:'Inter', Helvetica, Arial, sans-serif;font-size:16px;line-height:24px;padding-top:40px;padding-bottom:40px;padding-right:50px;padding-left:50px;">
                                    ...
                                    <p class="logo" style="margin-right:0;margin-left:0;line-height:28px;font-weight:600;font-size:21px;color:#111111;text-align:center;margin-top:0;margin-bottom:40px;"><span style="color:#0052e2;font-family:Arial, Helvetica, sans-serif;font-size:30px;vertical-align:bottom;">
                                        <img style="width:100px;" width="40" src="{{ asset('assets/images/logo.png') }}" alt="Logo"></span><span style="line-height:50px;"></span></p>

                                    <h1 style="margin-top:0;color:#111111;font-size:24px;line-height:36px;font-weight:600;margin-bottom:24px;">Willkommen, BLABLA!</h1>

                                    <p style="color:#4a5566;margin-top:20px;margin-bottom:20px;margin-right:0;margin-left:0;font-size:16px;line-height:28px;">
                                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquid aspernatur beatae corporis culpa cum dolor ducimus esse ex expedita explicabo fugiat hic id ipsa ipsum, iusto laboriosam minus modi mollitia nemo nobis omnis perspiciatis praesentium qui quis quisquam ratione reiciendis sed sit, temporibus ullam unde velit vero voluptatem? Amet, sint.
                                    </p>
                                    ...
                                    {{--<p class="small" style="color:#4a5566;margin-top:20px;margin-bottom:20px;margin-right:0;margin-left:0;font-size:14px;line-height:21px;">Sollte es Probleme mit dem Button oben geben, kopiere folgende URL in die Adresszeile Deines Browsers:</p>
                            ...
                            <tr>
                                <td class="ms-content-body" align="center" style="word-break:break-word;font-family:'Inter', Helvetica, Arial, sans-serif;font-size:16px;line-height:24px;padding-top:40px;padding-bottom:40px;padding-right:50px;padding-left:50px;">
                                    <p class="small" style="margin-top:20px;margin-bottom:20px;margin-right:0;margin-left:0;color:#96a2b3;font-size:14px;line-height:21px;">©
                                        {{ now()->year }} {{ config('app.name') }}. Alle Rechte vorbehalten.</p>
                                </td>
                            </tr>
                        </table>
