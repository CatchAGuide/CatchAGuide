...
<body style=" font-family: 'Morrison', sans-serif;margin: 0;padding: 0;font-style: 16px;">
...
<div class="container" style=" width: 100%;max-width: 600px;margin: 0 auto;background-color: white;box-shadow: 0 4px 6px 3px rgba(0, 0, 0, 0.1);">
    <div class="header" style="text-align: center;padding: 20px;">
        ...
        <h2 class="header-title">
            Bestätige Deine E-Mail-Adresse, um die Registrierung abzuschließen
        </h2>
    </div>
    <div class="content" style="padding-bottom:0px;">
        <div class="content-header" style="padding: 20px;">
            <p style="font-size:16px;">Lieber [User Name],</p>
            <p>
                vielen Dank für Deine Registrierung bei Catch A Guide! Wir freuen uns, Dich an Bord zu haben.
            </p>
            </p>
            <p>Um Deine Registrierung abzuschließen und Deine E-Mail-Adresse zu bestätigen, klicke bitte auf den Button unten, um Dein Konto zu verifizieren:
            </p>
            <div style="text-align:center; margin: 2rem 0;">
                <a class="btn-theme" style="background-color: #e8604c;padding:10px 20px;color:#fff !important;border:0;text-decoration: none;margin-top:30px;" style="background-color: #e8604c;padding:10px 20px;color:#fff !important;border:0;text-decoration: none;margin-top:30px;" href="https://catchaguide.com/contact">Verify account</a>
            </div>
            <p>Durch die Bestätigung Deiner E-Mail erhältst Du vollen Zugang zu unserer Plattform und allen Funktionen. Falls Du Dich nicht für ein Konto registriert hast, kannst Du diese E-Mail ignorieren.</p>
        </div>
    </div>
    <div style="margin-bottom:3rem; padding: 0 20px;">
        <p>
            Wenn Du Unterstützung benötigst, zögere nicht, uns zu kontaktieren. Wir sind hier, um zu helfen!
        </p>
        <p style="margin-top: 2rem;">Willkommen bei Catch A Guide!</p>
    </div>
