...
<div class="container" style=" width: 100%;max-width: 600px;margin: 0 auto;background-color: white;box-shadow: 0 4px 6px 3px rgba(0, 0, 0, 0.1);">
    <div class="header" style="text-align: center;padding: 20px;">
        ...
        <h2 class="header-title">Vielen Dank für deine Anmeldung zum Catch A Guide Newsletter!</h2>
    </div>
    <div class="content" style="padding-bottom:0px;">
        <div class="content-header" style="padding: 20px;">
            <p style="font-size:16px;">Lieber [Guest name],</p>
            <p>vielen Dank, dass du dich für den Catch A Guide Newsletter angemeldet hast! Du bist nun Teil unserer exklusiven Community und wirst regelmäßig mit den neuesten Informationen rund um Touren, Angelurlaube und spannende Angebote versorgt.</p>
            <p>Was dich erwartet:</p>
            <ul>
                <li><p>Aktuelle Touren: Bleibe immer auf dem neuesten Stand und erfahre als Erstes von neuen Angelreisen und Touren.</p></li>
                <li><p>Exklusive Angebote: Als Abonnent erhältst du spezielle Rabatte und Angebote, die nur für Newsletter-Abonnenten verfügbar sind.</p></li>
                <li><p>Tipps und Tricks: Hole dir die besten Angeltipps und bereite dich auf deinen nächsten Trip perfekt vor.</p></li>
            </ul>
            <p>Bleib dran!</p>
            <p>Schau regelmäßig in deinen Posteingang, um keine Neuigkeiten zu verpassen und dein nächstes Abenteuer zu planen.</p>
            <p>Falls du Fragen hast oder Unterstützung benötigst, stehen wir dir gerne zur Verfügung.</p>
        </div>
        <div style="padding: 0 20px;">
            <p>
                Wir freuen uns, dich auf deiner Angelreise zu begleiten!
            </p>
