...
<head>
    ...
    <title>Booking Request Expired - Guide Unable to Take Action</title>
...
<div class="container">
    ...
    <div class="content" style="padding-bottom:0px;">
        <div class="content-header">
            ...
            <p>@lang('profile.ceo-gdu-unable') {{$guide->firstname}} @lang('profile.ceo-gdu-unable2') {{$booking->created_at->diffInHours($booking->expires_at)}} @lang('profile.ceo-gdu-unable3')</p>
            <p>@lang('profile.ceo-gdu-detail'):</p>
