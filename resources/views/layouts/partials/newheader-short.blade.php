...
<nav class="navbar-custom short-header {{ request()->is('/') ? 'with-bg' : '' }} {{ request()->is('guidings*') ? 'no-search' : '' }} {{ (request()->is('checkout') || request()->is('modern-checkout')) ? 'checkout-minimal' : '' }}">
    <div class="container">
        <!-- Top Row -->
        <div class="row align-items-center">
            ...
            <div class="col-12 d-flex justify-content-between align-items-center">
                ...
                <div class="d-none d-md-flex align-items-center top-nav-items">
                    ...
                    @if(!(request()->is('checkout') || request()->is('modern-checkout')))
            ...
            @if(!$isVacation && !(request()->is('checkout') || request()->is('modern-checkout')))
                <div class="col-12 d-md-none mt-2">
            ...
            @elseif(!(request()->is('checkout') || request()->is('modern-checkout')))
