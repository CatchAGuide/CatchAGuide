    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="changePasswordModalLabel">{{ translate('Change Password') }}</h5>
            </div>
            <form action="{{ route('password.change') }}" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label for="new_password_confirmation" class="form-label">{{ translate('Confirm New Password') }}</label>
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn theme-primary">{{ translate('Update Password') }}</button>
                </div>
            </form>
        </div>
    </div>
