...
@section('title', 'Guide #' . $guide->id . ' editieren')
                            ...
                            <form action="{{route('admin.guides.update', $guide->id)}}" method="post">
                                    ...
                                    <div class="col-lg-4 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="firstname" name="firstname"
                                                   placeholder="Vorname" value="{{ $guide->firstname }}">
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-12">
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" class="form-control" id="address" placeholder="Straße" required
                                               name="information[address]" value="{{$guide->information->address ?? ''}}">
                                    </div>
                                    <div class="form-group col-md-2">
                                        <label for="address_number">Nr.<span style="color: #e8604c">*</span></label>
                                        <input type="number" class="form-control" id="address_number" placeholder="Nr."
                                               name="information[address_number]"
                                               value="{{$guide->information->address_number ?? ''}}" required>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" class="form-control" id="postal" name="information[postal]" placeholder="PLZ"
                                               value="{{$guide->information->postal ?? ''}}" required>
                                    </div>
                                    <div class="form-group col-md-8">
                                        ...
                                        <input type="text" class="form-control" id="city" name="information[city]" placeholder="Stadt"
                                               value="{{$guide->information->city ?? ''}}" required>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="phone" name="information[phone]" placeholder="Telefonnummer"
                                               value="{{$guide->information->phone ?? ''}}" required>
                                    </div>
                                    <div class="form-group col-md-6">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for="taxId">Umsatzsteuer-Identifikationsnummer</label>
                                        <input type="text" class="form-control" id="taxId" name="taxId" placeholder="Umsatzsteuer-Identifikationsnummer"
                                               value="{{$guide->tax_id ?? ''}}">
                                    </div>
                                </div>
                                <div class="card-footer text-end">
                                    ...
                                    <a href="{{ route('admin.customers.index') }}"
                                       class="btn btn-danger my-1">Abbrechen</a>
                                </div>
                            </form>
