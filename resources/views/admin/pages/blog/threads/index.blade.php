                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <a href="{{ route('admin.blog.threads.create') }}" class="btn btn-primary">Beitrag erstellen</a>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table blog-table table-bordered text-nowrap border-bottom" id="responsive-datatable">
                                    ...
                                    <tr>
                                        ...
                                        <th class="wd-20p border-bottom-0">Kategorie</th>
                                    ...
                                    <tbody>
                                        @foreach($threads as $thread)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('admin.blog.threads.edit', $thread) }}" class="btn btn-sm btn-secondary"><i class="fa fa-pencil"></i></a>
                                                    <a href="{{ route('admin.blog.delete', $thread) }}" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i></a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
