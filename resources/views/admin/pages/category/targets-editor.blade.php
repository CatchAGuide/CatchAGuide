        ...
        <div class="page-header">
            <div>
                ...
                <p class="text-muted mb-0">
                    ...
                    ·
                    <a href="{{ route('admin.category.target-fish.index') }}">{{ __('admin.category_pages.editor.back_to_list') }}</a>
                </p>
            </div>
        </div>
        ...
        <form action="{{ $route }}" method="post" enctype="multipart/form-data" id="category-scoped-form">
            ...
            <div class="category-editor__layout">
                <aside class="category-editor__rail">
                    ...
                    <p class="category-editor__note">{{ __('admin.category_pages.global_note') }}</p>
                </aside>
...
<script>
    ...
    const languageDataUrl = @json(route('admin.category.target-fish.language-data', $targetId));
    let faqIndex = 0;
