...
@section('title', __('trips.catalog_title'))
@section('header_title', __('trips.catalog_header_title'))
@section('header_sub_title', __('trips.catalog_header_sub_title'))
@section('description', __('trips.catalog_header_sub_title'))
...
@section('custom_style')
    ...
    .trending-card .trending-card-background {
        width: 100%;
        height: 100%;
        object-fit: cover;
        display: block;
            ...
            <div class="page-header__bottom breadcrumb-container">
                <div class="page-header__bottom-inner">
                    <ul class="thm-breadcrumb list-unstyled">
                        ...
                        <li class="active">{{ __('trips.catalog_breadcrumb') }}</li>
                    </ul>
                </div>
            </div>
        </section>
    ...
    <section class="toptargetfish">
        <div class="container my-4">
            ...
            <div class="row">
                        ...
                        <div class="trending-card">
                            <a href="{{ route('trips.category', ['location' => $loc->slug]) }}">
                                <div class="trending-card-wrapper">
                                    <img alt="{{ translate($loc->name) }}" class="trending-card-background" src="{{ asset($loc->thumbnail_path ?? 'images/placeholder_guide.jpg') }}">
                ...
                @empty
                    <p class="text-muted">@lang('trips.catalog_no_locations')</p>
                @endforelse
            </div>
        </div>
    </section>
