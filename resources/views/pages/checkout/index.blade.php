...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.0.3/css/font-awesome.css" />
    <style> 
        ...
        .heading h5 {
            ...
            border-bottom: solid 5px #d76232;
            line-height: 1.1;
            margin-bottom: 0;
            padding-bottom: 10px;
        ...
        #checkout .nav {
            margin-bottom: 20px;
            border-bottom: solid 1px #d76232;
        }
        ...
        .nav-tabs > li > a:hover {
            border-color: #eeeeee #eeeeee #d76232;
        }
