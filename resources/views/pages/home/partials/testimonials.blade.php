...
<section id="cag-home-reviews" class="cag-home-section cag-home-reviews" data-cag-reveal>
    <div class="cag-home-container">
        <div class="cag-home-section__header cag-home-reviews__header-bar cag-reveal__header">
            <h2 class="cag-home-section__title">{{ __('homepage.reviews_title') }}</h2>
            <div class="cag-home-reviews__nav d-none d-md-flex">
                <button type="button" class="cag-home-icon-btn" data-reviews-prev aria-label="{{ __('homepage.reviews_slider_prev') }}">
                    <i class="fas fa-chevron-left" aria-hidden="true"></i>
                </button>
                <button type="button" class="cag-home-icon-btn" data-reviews-next aria-label="{{ __('homepage.reviews_slider_next') }}">
                    <i class="fas fa-chevron-right" aria-hidden="true"></i>
                </button>
            </div>
        </div>

        <div class="cag-home-reviews__slider cag-reveal__block">
