        ...
        <div class="page-header__top">
            ...
            <div class="container">
                <div class="page-header__top-inner">
                    <h1 class="h2">{{ucwords(isset($place) ? translate('Alle Guidings bei ') . $place : translate('Alle Guidings') )}}</h>
                </div>
            </div>
        </div>
                            ...
                            <div class="col-6 col-sm-6 col-md-4">
                                <div class="form-group my-1">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input  id="searchPlace" name="place" type="text" value="{{ request()->get('place') ? request()->get('place') : null }}" class="form-control border-0 border-bottom rounded-0" placeholder="@lang('message.enter-location')"  autocomplete="on">
                                    </div>
