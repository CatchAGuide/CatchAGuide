...
<section id="hero" class="theme-primary" style="background: linear-gradient(0deg, rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url({{asset('assets/2024/header_banner.webp')}}); background-size:cover;background-position:center;height:50vh;">
    @if($agent->ismobile())
    <div class="hero-container row h-100  p-5 mx-5 align-items-center">
        <div class="col-md-12 text-white m-0">
            <h1 class="text-white fw-bold my-2">@lang('homepage.header-title')</h1>
            <div class="row">
                <div class="col-md-12">
...
<section id="nearest-listing" class="offer my-5 py-1 d-none">
...
<section class="fishing-experience my-5 py-1">
    <div class="container">
          ...
          <div class="tab-content my-3" id="myTabContent">
            ...
            <div class="tab-pane fade" id="boat" role="tabpanel" aria-labelledby="boat-tab">
                <div class="row px-3">
                    ...
                    <div class="d-flex justify-content-end p-1">
                        <a href="/guidings?waters[]=2" class="color-primary">@lang('homepage.see-more')</a>
                    </div>
            ...
            <div class="tab-pane fade" id="pelagic" role="tabpanel" aria-labelledby="pelagic-tab">
                <div class="row px-3">
                    ...
                    <div class="d-flex justify-content-end p-1">
                        <a href="http://" class="color-primary">@lang('homepage.see-more')</a>
                    </div>
            ...
            <div class="tab-pane fade" id="shorefishing" role="tabpanel" aria-labelledby="shorefishing-tab">
                <div class="row px-3">
                    ...
                    <div class="d-flex justify-content-end p-1">
                        <a href="/guidings?fishingFrom[]=1" class="color-primary">@lang('homepage.see-more')</a>
                    </div>
...
<section class="popular-trips my-5 py-1">    
    <div class="container popular-tours p-3 mt-0">
        <div class="section-title my-2">
...
<section class="topfishingtypes my-5 py-1">
    <div class="container my-4">
        <div class="section-title my-2">
...
<section class="banner my-5 py-1">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12 text-white">
                                        <div class="video-one__left">
                                            <h3 class="h1 text-white fw-bolder">@lang('homepage.guide-title')</h3>
...
<section class="toptargetfish my-5 py-1">
    <div class="container my-4">
        <div class="section-title my-2">
...
<section class="fishing-magazine my-5 py-1">
    <div class="container my-5">
        <div class="section-title my-2">
                ...
                <div class="section-card">
                    <a href="{{ route($blogPrefix.'.thread.show', [$thread->slug]) }}">
                        ...
                        url('{{ $thread->getThumbnailPath() }}')">
                            <div class="">
                                <div class="overlay-wrapper"></div>
                                <div class="section-card-main position-absolute bottom-0 p-4 text-white">
