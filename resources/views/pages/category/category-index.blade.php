                        ...
                        <div class="trending-card">
                            <a href="{{ route($route, ['slug' => $item->slug]) }}"> 
                                <div class="trending-card-wrapper">
                                    <img alt="{{$item->language->title}}" class="trending-card-background" src="{{asset($item->thumbnail_path ?? 'images/placeholder_guide.jpg')}}">

                                    <div class="trending-card-wrapper-content">
                                        <div class="overlay-wrapper"></div>
                                        <div class="trending-card-main">
                                            <div class="trending-text-wrapper">
                                                <h4 class="trending-title">{{$item->language->title}}</h4>
                                            </div>
                                        </div>
                                    </div>
                                </div>
